			...
			<div class="col-md-11">
				<nav class="nav nav-top justify-content-end bg">
					<p class="text-danger mt-2">
						Welcome,
						<%=user%></p>
					<a class="nav-link" href="/PRJ321x_Project_2_thanhchfx01399/home.jsp"><i class="fa fa-th-large"></i></a> <a
						class="nav-link" href="#"><i class="fa fa-user"></i></a> <a
						class="nav-link" href="/PRJ321x_Project_2_thanhchfx01399/logout">Log
						out</a>
				</nav>
